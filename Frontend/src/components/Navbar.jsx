...
export default function Navbar() {
  ...
  return (
    <>
      <div
        className={`max-w-screen-2xl container mx-auto md:px-20 dark:bg-slate-900 px-4 fixed top-0 left-0 right-0 z-50 ${
          stick
      ...
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="text-2xl font-bold cursor-pointer">myBook</a>
          </div>
